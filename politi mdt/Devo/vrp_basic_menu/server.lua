                            ...
                            if target ~= nil then
                                ...
                                vRPclient.isHandcuffed(target,{}, function(handcuffed)
                                    if handcuffed then
                                        ...
                                        PerformHttpRequest('https://discord.com/api/webhooks/773644330702602250/u7xd4_BGavTsyt4_yjjhq9wnE38qCMmkYzvRsvl1dEOXTNRy_VqoUXBsU5vUl9AAU-lm', function(err, text, headers) end, 'POST', json.encode({username = "Server " .. GetConvar("servernumber","0").." - Fængsel", content = "**"..user_id .. "** fængslet **"..target_id.."** i **" .. jail_time .. " minut(ter)**"}), { ['Content-Type'] = 'application/json' })
                                    else
